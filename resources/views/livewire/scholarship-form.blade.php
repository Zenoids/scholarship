@php
    ...
    $forminputstyle =
        'block ps-3 w-11/12   rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6';
@endphp
...
<section>
    ...
    <div class="bg-[#F2F4F7]">
        ...
        <form class="flex md:ms-[20%] md:w-8/12 w-full flex-col" enctype="multipart/form-data"
            ...
            @if (!$hasRegistered || $hasRenewalRegistered == 1)
                @if ($currentPage == 1)
                    <div id="section1"
                        class="flex  rounded-xl  shadow-xl   bg-white py-4 mx-5 my-6 flex-col {{ $hasRenewalRegistered == 1 ? 'd-none' : '' }}">
                        <div class="mx-6 my-6">
                            <div class="">
                            ...
                            <div class="flex flex-col md:flex-row">
                                ...
                                <div class="md:w-4/5 w-full  flex flex-wrap  ">
                                    ...
                                    <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                        ...
                                        <input required type="text" name="tahsil" id="tahsil"
                                            wire:model="tahsil" class="{{ $forminputstyle }}">
                                        @error('tahsil')
                                    ...
                                    <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                        <x-forminput label="State" name="state" type="text"
                                            wire:model="state" />
                                    </div>
                        ...
                        <div class="mx-6 my-6">
                            <div class="">
                                    ...
                                    <div class="md:w-4/5 w-full  flex flex-wrap  ">
                                        ...
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            ...
                                            <select name="course_id" id="course_id"
                                                class="{{ $forminputstyle }}" wire:model="course_id">
                                                <option value="">Select a Course</option>
                                                @foreach ($courses as $course)
                                                    <option wire:key="{{ $course->id }}"
                                                        value="{{ $course->id }}">
                                                        {{ $course->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="Course Period" name="course_period"
                                                type="text" wire:model="course_period" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="Current Year" name="current_year" type="text"
                                                wire:model="current_year" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="Entrance Rank" name="rank_entrance"
                                                type="text" wire:model="rank_entrance" />
                                        </div>
                                        {{-- </div>
                                        <div class="flex flex-col md:flex-row mt-5"> --}}
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="Institute Name" name="institute_name"
                                                type="text" wire:model="institute_name" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                        ...
                                        <div class="md:w-1/3 w-full mt-2 md:mt-3">
                                            <x-forminput label="Institute State" name="institute_state"
                                                type="text" wire:model="institute_state" />
                                        </div>
                                        <div class="md:w-1/3 w-full mt-2 md:mt-3">
                                            <x-forminput label="Institute District" name="institute_district"
                                                type="text" wire:model="institute_district" />
                                        </div>
                                        <div class="md:w-1/3 w-full mt-2 md:mt-3">
                                            <x-forminput label="Institute Locality" name="institute_locality"
                                                type="text" wire:model="institute_locality" />
                                        </div>
                                        {{-- </div> --}}
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col md:flex-row">
                                    ...
                                    <div class="md:w-4/5 w-full  flex flex-wrap  mt-2 md:mt-3">
                                        {{-- <div class="flex flex-col md:flex-row"> --}}
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="Previous Course Name" name="previous_course_name"
                                                type="text" wire:model="previous_course_name" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="Previous Subjects taken"
                                                name="previous_course_subjects" type="text"
                                                wire:model="previous_course_subjects" />
                                        </div>
                                        {{-- </div>
                                        <div class="flex flex-col md:flex-row mt-5"> --}}
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="Previous Education Institute"
                                                name="previous_course_institution" type="text"
                                                wire:model="previous_course_institution" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="% Marks Achived Previously"
                                                name="previous_course_marks" type="number"
                                                wire:model="previous_course_marks" max="99"
                                                min="1" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <x-forminput label="Previous Hall ticket Number"
                                                name="previous_hallticket" type="text"
                                                wire:model="previous_hallticket" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row">
                                <div class="md:w-1/5 w-full flex-col me-8">
                                    ...
                                    <p class="{{ $mainsubstyle }}">please enter the 10 class details accurately
                                    </p>
                                </div>
                                <div class="md:w-4/5 w-full  flex flex-wrap  mt-2 md:mt-3">
                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                    ...
                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                        <x-forminput label="% Marks Achived " name="tenth_marks" type="number"
                                            max="99" min="1" wire:model="tenth_marks" />
                                    </div>
                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                            ...
                            <div class="flex flex-col md:flex-row">
                                ...
                                <div class="md:w-4/5 w-full  flex flex-wrap  mt-2 md:mt-3">
                                    ...
                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                        <x-forminput label="% Marks Achived " name="inter_marks" type="number"
                                            max="99" min="1" wire:model="inter_marks" />
                                    </div>
                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                            ...
                            <div class="flex justify-between">
                                <div class=""><button wire:click="backonepage" type="button"
                                        class=" inline-block rounded bg-blue-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] {{ $hasRenewalRegistered == 1 ? 'hidden' : '' }}">
                                        Previous
                                    </button></div>
                                <div class="flex">
                                    ...
                                    <button wire:click="educationUpdate" type="button"
                                        class="mx-4 inline-block rounded bg-green-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] {{ $hasRenewalRegistered != 1 ? 'hidden' : '' }}">
                                        Submit
                                    </button>
                            ...
                            <div class="">
                                ...
                                <div class="flex flex-col md:flex-row ">
                                    ...
                                    <div class="md:w-4/5 w-full  flex flex-wrap  mt-2 md:mt-3">
                                        {{-- <div class="flex flex-col md:flex-row"> --}}
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                            <x-forminput label="Fathers Occupation" name="fathers_occupation"
                                                type="text" wire:model="fathers_occupation" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                            <x-forminput label="Fathers Monthly Income"
                                                name="fathers_monthly_income" type="text"
                                                wire:model="fathers_monthly_income" />
                                        </div>
                                        {{-- </div>
                                        <div class="flex flex-col md:flex-row mt-5"> --}}
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                            <x-forminput label="Expense Bearer" name="expense_bearer"
                                                type="text" wire:model="expense_bearer" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                ...
                                <div class="flex flex-col md:flex-row">
                                    ...
                                    <div class="md:w-4/5 w-full  flex flex-wrap  mx-2">
                                        {{-- <div class="flex flex-col md:flex-row"> --}}
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                            <x-forminput label="Name of account holder" name="name_ac_holder"
                                                type="text" wire:model="name_ac_holder" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                        ...
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                            <x-forminput label="Bank Account Number" name="ac_number"
                                                type="password" wire:model="ac_number" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                            <x-forminput label="Confirm Account Number" name="confirm_ac_number"
                                                type="text" wire:model="confirm_ac_number" />
                                        </div>
                                        {{-- </div>
                                        <div class="flex flex-col md:flex-row mt-5"> --}}
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                            <x-forminput label="Bank account branch name" name="ac_branch"
                                                type="text" wire:model="ac_branch" />
                                        </div>
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3 ">
                                            <x-forminput label="IFSC Code" name="ifsc" type="text"
                                                wire:model="ifsc" />
                                        </div>
                                        {{-- </div> --}}
                                    </div>
                    ...
                    <div id="section4" class="flex  rounded-xl  shadow-xl   bg-white py-4 mx-5 my-6 flex-col">
                        <div class="mx-6 my-6">
                            <div class="">
                                ...
                                <p class="{{ $mainsubstyle }}">Please upload the updated files required for easy
                                    verification
                                    try
                                ...
                                <div class="flex flex-col md:flex-row">
                                    <div class="md:w-1/5 w-full flex-col me-8">
                                        ...
                                        <p class="{{ $mainsubstyle }}">Make sure to upload latest files of minimum
                                            size</p>
                                    </div>
                                    <div class="md:w-4/5 w-full  flex flex-wrap ">
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            ...
                                            <input type="file" accept=".jpg,.png,.jpeg,.webp,.pdf" required
                                                name="photofile" wire:model="photofile"
                                        ...
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            ...
                                            <input type="file" accept=".jpg,.png,.jpeg,.webp,.pdf" required
                                                name="feesfile" wire:model="feesfile"
                                                class="rounded-md bg-white px-2.5 py-1.5  w-5/6 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                                            @error('feesfile')
                                                <div class="text-red-800 text-sm">
                                                    {{ $message }} </div>
                                        ...
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            ...
                                            <input type="file" accept=".jpg,.png,.jpeg,.webp,.pdf" required
                                                name="marksfile" wire:model="marksfile"
                                                class="rounded-md bg-white px-2.5 py-1.5  w-5/6 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                                            @error('marksfile')
                                                <div class="text-red-800 text-sm">
                                                    {{ $message }} </div>
                                        ...
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            ...
                                            <input type="file" accept=".jpg,.png,.jpeg,.webp,.pdf" required
                                                name="adhaarfile" wire:model="adhaarfile"
                                                class="rounded-md bg-white px-2.5 py-1.5  w-5/6 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                                            @error('adhaarfile')
                                                <div class="text-red-800 text-sm">
                                                    {{ $message }} </div>
                                        ...
                                        <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                            <label class="{{ $formlabelstyle }}">Bank Account Passbook
                                                photo</label>
                                            <input type="file" accept=".jpg,.png,.jpeg,.webp,.pdf" required
                    ...
                    <div id="section5" class="flex  rounded-xl  shadow-xl   bg-white py-4 mx-5 my-6 flex-col">
                        <div class="mx-6 my-6">
                            <div class="">
                                ...
                                <p class="{{ $mainsubstyle }}">Please Select carefully the nearest Jamaat Islami
                                    Hind
                                    office, As your scholarship will be verified and approved by the nearest office
                                </p>
                                <hr class="my-12">
                                <div class="flex flex-col md:flex-row">
                                    <div class="md:w-1/5 w-full flex-col me-8">
                ...
                @if ($currentPage == 6)
                    <div id="section2" class="flex  rounded-xl  shadow-xl   bg-white py-4 mx-5 my-6 flex-col">
                        <div class="mx-6 my-6">
                            ...
                            <hr class="my-12">
                            <div id="section4" class="flex  rounded-xl bg-white py-4 flex-col">
                                <div class="">
                                    <div class="">
                                        <p class="{{ $mainheadingstyle }}">Upload the required Files</p>
                                        <p class="{{ $mainsubstyle }}">Please upload the updated files
                                            required for easy
                                            verification
                                            try
                                            to upload compressed image of max size 2mb</p>
                                        ...
                                        <div class="flex flex-col md:flex-row">
                                            <div class="md:w-1/5 w-full flex-col me-8">
                                                <h3 class="{{ $sideheadstyle }}">Upload files</h3>
                                                <p class="{{ $mainsubstyle }}">Make sure to upload latest
                                                    files of minimum
                                                    size</p>
                                            </div>
                                            <div class="md:w-4/5 w-full  flex flex-wrap ">
                                                <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                                    <label class="{{ $formlabelstyle }}">Course fee
                                                        photo</label>
                                                    <input type="file" accept=".jpg,.png,.jpeg,.webp,.pdf"
                                                        required name="renewfeesfile" wire:model="renewfeesfile"
                                                        class="rounded-md bg-white px-2.5 py-1.5  w-5/6 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                                                    @error('renewfeesfile')
                                                        <div class="text-red-800 text-sm">
                                                            {{ $message }} </div>
                                                ...
                                                <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                                    <label class="{{ $formlabelstyle }}">Previous Marks
                                                        Card</label>
                                                    <input type="file" accept=".jpg,.png,.jpeg,.webp,.pdf"
                                                        required name="renewmarksfile" wire:model="renewmarksfile"
                                                        class="rounded-md bg-white px-2.5 py-1.5  w-5/6 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                                                    @error('renewmarksfile')
                                                        <div class="text-red-800 text-sm">
                                                            {{ $message }} </div>
                                                    @enderror
                                                </div>
                            ...
                            <div class="flex justify-between">
                                <div class="flex">
                                    <button wire:click="renewSubmission" type="button"
                                        class="mx-4 inline-block rounded bg-green-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] {{ $hasRenewalRegistered != 1 ? 'hidden' : '' }}">
                                        Submit
                                    </button>
                                    <button wire:click="renewFormReset" type="button"
                                        class="inline-block rounded bg-red-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)]">
                                        Reset
                                    </button>
                                </div>
            ...
            @else
                <div id="section1" class="flex  rounded-xl  shadow-xl   bg-white py-4 mx-5 my-6 flex-col">
                    <div class="mx-6 my-6">
                        <div class="">
                            <p class="{{ $mainheadingstyle }}">You have already registered at
                                {{ $user->created_at->format('d-M-Y') }}</p>
                            <p class="{{ $mainsubstyle }}">We will get back to you after we review your
                                application, if you want to fill another form , please logout from this profile by
                                clicking your name at right corner and either register a new user or login with new
                                user who has applied yet</p>
                            @if ($hasRenewalRegistered == 0)
                                <p class="{{ $mainsubstyle }}">Please note, you are not eligible to submit a
                                    renewal application.</p>
                            @endif
                            <p>For more information contact to <a
                                    href="mailto:scholarship@jih.org.in">scholarship@jih.org.in</a></p>
                        </div>
                        <hr class="my-12">
                    </div>
                </div>
