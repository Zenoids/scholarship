...
<section>
    ...
    <div class="bg-[#F2F4F7]">
        {{-- <div class="flex w-full pt-5">
            <div class="flex fixed md:w-2/12 md:ms-32 my-5 flex-col">`w
        ...
        <div class="flex py-5 md:ms-[16%] md:w-8/12 w-full flex-col">
                ...
                <div class="mx-6 my-6">
                    <div class="">
                        ...
                        <div class="flex flex-col md:flex-row ">
                            ...
                            <div class="text-center w-full  flex flex-wrap ">


                                <div class="flex  flex-col w-full">
                                    <h1 class="text-center text-2xl font-semibold">
                                        {{ App\Models\Scholarship::latest()->first()->name }}
                                    </h1>
                        ...
                        <div class="flex flex-col md:flex-row ">
                            <div class="md:w-1/5 w-full flex-col">
                                ...
                                <p class="{{ $mainsubstyle }}"> Please make sure to keep the given data and files ready
                                    with you </p>
                            </div>
                            <div class="md:w-4/5 w-full  flex flex-wrap ">
                                    ...
                                    <ul class="text-gray-700 md:ms-5 list-disc">
                                        ...
                                        <li><b>Mandatory Attachments: </b>
                                            <ul class="text-gray-700 md:ms-5 list-disc">
                                                ...
                                                <li>Attachment of your passport size photo </li>
                                            </ul>
                                            <b> supported formats .pdf, .jpeg, .jpg, .png and maximum upload size:
                                                2MB</b>
                                        </li>
                        ...
                        @if ($currentPage == 2)
                            @guest
                                ...
                                <div class="flex flex-col md:flex-row ">
                                    ...
                                    <div>
                                        <!-- Dropdown -->
                                        <div class="mb-4 ms-3" style="width: 200px; min-width: 200px; max-width: 200px;">
                                            <select
                                                onchange="
            const form = document.getElementById('registrationForm');
            const msg = document.getElementById('yearWarning');
            if (this.value === '1') {
        ...
        "
                                                wire:model="year" {{-- Add Livewire model binding here --}}
                                                class="block mt-1 w-full border-gray-500 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                        ...
                                        <!-- Warning Message -->
                                        <p id="yearWarning" class="hidden text-red-600 font-semibold mt-3">
                                            Fresh registration is only available for 1st Year students.
                                        </p>
                                            ...
                                            <form class=" " wire:submit.prevent="register">
                                                <div class="md:w-4/5 w-full ms-5 flex flex-wrap">
                                                    ...
                                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                                        ...
                                                        <x-text-input id="name" class="block mt-1 w-11/12"
                                                    ...
                                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                                        ...
                                                        <x-text-input wire:model="email" id="email"
                                                            class="block mt-1 w-11/12" type="email" name="email"
                                                    ...
                                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                                        ...
                                                        <x-text-input wire:model="password" id="password"
                                                            class="block mt-1 w-11/12" type="password" name="password"
                                                    ...
                                                    <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                                        ...
                                                        <x-text-input wire:model="password_confirmation"
                                                            id="password_confirmation" class="block mt-1 w-11/12"
                                            ...
                                            <div class="md:w-4/5 w-full ms-5 flex flex-wrap">
                                                ...
                                                <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                                    ...
                                                    <x-text-input wire:model="name" id="name"
                                                        class="block mt-1 w-11/12" type="text" name="name" required
                                                ...
                                                <div class="md:w-1/2 w-full mt-2 md:mt-3">
                                                    <x-input-label for="email" :value="__('Email')" />
                                                    <x-text-input wire:model="email" id="email"
                                                        class="block mt-1 w-11/12" type="email" name="email" required
                        ...
                        <!-- JavaScript -->
                        <script>
                            function toggleForm(selectedValue) {
