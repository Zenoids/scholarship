...
class DashboardController extends Controller
{
    ...
    public function exportAllPdf(){
        ...
        // ]);
        $pdf = Pdf::loadView('exports.pdf', ['students' => $query->with(['units','states','addresses','incomes','educations','previous','uploads','approvals','amounts','user','verify','office','comments'])->get()]);
